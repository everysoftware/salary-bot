...
from src.db.aggregate import aggregate_payments
from src.schemes import SRequest, SResponse
...
def test_aggregate_payments(s_request: SRequest, s_response: SResponse):
    result = aggregate_payments(s_request)

    # assert result.labels == s_response.labels
    assert result.dataset == s_response.dataset
